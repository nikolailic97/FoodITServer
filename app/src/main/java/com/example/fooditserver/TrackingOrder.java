...
import com.example.fooditserver.Common.DirectionJSONParser;
        ...
        LocationListener
{
    ...
    private void displayLocation() {
                ...
                Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED)
        {
            ...
            if(mLastLocation != null) {
                ...
                //Add Marker for your locationo, and Marker for Order location and Draw route
    ...
    private void drawRoute(final LatLng yourLocation, String address) {
        mService.getGeoCode(address, "Api-key").enqueue(new Callback<String>() {
            @Override
