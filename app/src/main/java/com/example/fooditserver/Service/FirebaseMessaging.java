...
import com.example.fooditserver.Helper.NotificationHelper;
import com.example.fooditserver.MainActivity;
import com.example.fooditserver.OrderStatus;
...
public class FirebaseMessaging extends FirebaseMessagingService {
    ...
    private void sendNotification(RemoteMessage remoteMessage) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder((Context) this)
                .setSmallIcon(R.mipmap.ic_new_round)
